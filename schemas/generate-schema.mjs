 ...
 */
 ...
 fs.writeFileSync(path.join(__dirname, "/article-content.1.schema.json"), articleContent_output);
 ...
 fs.writeFileSync(path.join(__dirname, "/page-nav.1.schema.json"), pageNav_output);
 ...
 fs.writeFileSync(path.join(__dirname, "/page-nav-sensitive.1.schema.json"), pageNavSensitive_output);
 ...
 fs.writeFileSync(path.join(__dirname, "/total-timing.1.schema.json"), totalTiming_output);
